...
$(function () {
    ...
    $('#analyze-btn').on('click', function () {
        var formDate = $('#analyzeStartTime').val();
        var untilDate = $('#analyzeEndTime').val();
        //time fields validation
        var setDateError = false;
        ...
        var formSplitDate = formDate.split('/');
        var formDay = formSplitDate[0];
        formDay = deletefirstZero(formDay);
        var formMonth = formSplitDate[1];
        formMonth = deletefirstZero(formMonth);
        var formYear = formSplitDate[2];
        //handele end date input
        var untilSplitDate = untilDate.split('/');
        var untilDay = untilSplitDate[0];
        untilDay = deletefirstZero(untilDay);
        var untilMonth = untilSplitDate[1];
        untilMonth = deletefirstZero(untilMonth);
        var untilYear = untilSplitDate[2];
